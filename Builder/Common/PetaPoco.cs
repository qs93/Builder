...
namespace PetaPoco
{
    ...
    public class Database : IDisposable
    {
        ...
        public static Database db
        {
            get
            {
                Database context = CallContext.GetData(typeof(Database).Name) as Database;
                if (context == null)
                {
                    context = new Database();
                    CallContext.SetData(typeof(Database).Name, context);
                }
                return context;
            }
        }
        ...
        //public static string connectionStringNew = PubConstant.ConnectionString;
        //public static string providerNameNew = "System.Data.SqlClient";  
        ...
        public Database(string connectionString, string providerName)
        {
            ...
            _providerName = providerName;
            //_connectionString = connectionStringNew;
            //_providerName = providerNameNew;
            CommonConstruct();
        }

        //public Database( DbProviderFactory provider)
        ...
        public Database(string connectionStringName)
        {
            ...
            //connectionStringName = connectionStringNew;
        ...
        // Use `using (var scope=d1b.Transaction) { scope.Complete(); }` to ensure correct semantics
        ...
        {
            //string LogErr = "//**********************************************************************************************************************\r\n";
            //LogErr += DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "\r\n";
            //LogErr += "异常信息：(" + x.ToString() + ")\r\n";
            //LogErr += "异常SQL：(" + LastCommand + ")\r\n";
            //LogErr += "//**********************************************************************************************************************\r\n";
            //Log2Helper.WriteLog("PetaPoco", LogErr);
        ...
        #region GetDataSet、GetDataTable
        /// <summary>
        /// 获取DataSet
        /// </summary>
